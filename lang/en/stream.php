...
$string['defaultautoplaynext'] = 'Default autoplay next';
$string['defaultautoplaynext_desc'] = 'Set the default value for "Autoplay next video" when creating new Stream activities. When enabled, playlist videos play one after another automatically.';
$string['dragtoorder'] = 'Drag to reorder';
$string['paginationprevious'] = '« Previous';
$string['paginationnext'] = 'Next »';
$string['paginationsummary'] = 'Showing {$a->start}-{$a->end} of {$a->total} videos';
$string['paginationlabel'] = 'Video pagination';
$string['identifier'] = 'Video identifiers';
$string['identifier_help'] = 'The video identifiers from the stream server.';
$string['autoplaynext'] = 'Autoplay next video';
$string['autoplaynext_desc'] = 'Automatically advance to the next playlist video after the current video duration';
$string['autoplaynext_help'] = 'When enabled, Moodle advances the playlist automatically based on each video\'s length. This works without requiring updates to the Stream/VideoTube player. Students can still select any video manually.';
