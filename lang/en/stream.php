...
$string['autoplaynext_desc'] = 'Automatically play the next video in the playlist when the current one ends';
$string['autoplaynext_help'] = 'When enabled, the playlist automatically advances to the next video after the current video\'s duration. Students can still click any video manually.';
