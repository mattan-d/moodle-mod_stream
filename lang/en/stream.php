...
$string['autoplaynext_help'] = 'When enabled, finishing a video in a playlist automatically starts the next one. When disabled, students must click the next video manually.';
