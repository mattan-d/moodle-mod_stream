...
$string['autoplaynext_desc'] = 'מעבר אוטומטי לסרטון הבא בפלייליסט לפי אורך הסרטון הנוכחי';
$string['autoplaynext_help'] = 'כאשר האפשרות פעילה, Moodle מקדם את הפלייליסט אוטומטית לפי אורך כל סרטון. זה עובד גם בלי עדכון לנגן Stream/VideoTube. עדיין ניתן לבחור סרטון ידנית בכל רגע.';
...
$string['views'] = 'צפיות';
$string['viewed'] = 'נצפה';
$string['paginationprevious'] = '« הקודם';
$string['paginationnext'] = 'הבא »';
$string['paginationsummary'] = 'מציג {$a->start}-{$a->end} מתוך {$a->total} סרטונים';
$string['paginationlabel'] = 'דפדוף סרטונים';
