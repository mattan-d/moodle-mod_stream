...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtextarea('stream/audioplayer_idnumbers',
            get_string('audioplayer_idnumbers', 'mod_stream'),
            get_string('audioplayer_idnumbers_desc', 'mod_stream'), '', PARAM_TEXT));
